	...
	public function render() {
		...
		<form method="post">
			...
			<table class="form-table">
				<tbody>
					<tr>
						<th scope="row"><label for="wpvgw_minimum_character_count"><?php _e( 'Nötige Zeichenanzahl', WPVGW_TEXT_DOMAIN ); ?></label></th>
						<td>
							<p>
					...
					<tr>
						<th scope="row"><label for="wpvgw_output_format"><?php _e( 'Ausgabe-Format Zählmarke', WPVGW_TEXT_DOMAIN ); ?></label></th>
						<td>
							<p>
					...
					<tr>
						<th scope="row"><label for="wpvgw_default_server"><?php _e( 'Standard-Server', WPVGW_TEXT_DOMAIN ); ?></label></th>
						<td>
							<p>
